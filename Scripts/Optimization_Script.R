...
df <- readr::read_csv(paste0(input_folder_from_previous_step,"/Avg_",Day_type,"_zone",zone,".csv"))
...
proposed_cycle_period_1 <- as.integer(mean(df_subset_period_1$Nominal_Cycle_Length)/5)*5
...
for (period2 in period_2_hrs){
  ...
  if(period_2_upper <= 1440){
    ...
    proposed_cycle_period_2 <- as.integer(mean(df_subset_period_2$Nominal_Cycle_Length)/5)*5
    ...
    for (period3 in period_3_hrs){
      ...
      if(period_3_upper == 1440){
        ...
        proposed_cycle_period_3 <- as.integer(mean(df_subset_period_3$Nominal_Cycle_Length)/5)*5
        ...
        if(period_2_upper <= 1440){
          ...
          for (period4 in period_4_hrs){
            ...
            if(period_4_upper == 1440){
              ...
              proposed_cycle_period_4 <- as.integer(mean(df_subset_period_4$Nominal_Cycle_Length)/5)*5
                    ...
                    if(period_5_upper <= 1440){
                      ...
                      for (period7 in period_7_hrs){
                        ...
                        if(period_7_upper == 1440){
                          ...
                          proposed_cycle_period_7 <- as.integer(mean(df_subset_period_7$Nominal_Cycle_Length)/5)*5
                            ...
                            if(period_7_upper <= 1440){
                              ...
                              for (period9 in period_9_hrs){
                                ...
                                if(period_9_upper == 1440){
                                  ...
                                  proposed_cycle_period_9 <- as.integer(mean(df_subset_period_9$Nominal_Cycle_Length)/5)*5
...
readr::write_csv(df_final, paste0(output,"test.csv"))
